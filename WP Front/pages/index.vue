        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div class="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0  ">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <h1 class="flex items-center text-xl font-extrabold ">Group NB<span class="bg-red-100 text-red-800 text-lg font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-800 ml-2">Recruitement</span></h1>
...
async function login() {
    ...
    if(emailInput.value != '' &&  passwordInput.value != ''){
        ...
        await globalAPI().post(`Login/login`,
        {
