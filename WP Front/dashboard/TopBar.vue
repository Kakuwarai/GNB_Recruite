...
<div id="userDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ">
    ...
    <ul class="py-2 text-sm text-gray-700"  aria-labelledby="avatarButton">
      <li>
        <a class="block px-4 py-2  hover:bg-red-600 hover:text-white" @click="dashboard()">Dashboard</a>
      </li>
      <li>
        <a class="block px-4 py-2  hover:bg-red-600 hover:text-white" @click="$router.replace('/profile')">Profile</a>
      </li>
      <!-- <li>
    ...
    <div class="py-1">
      <a class="block px-4 py-2 text-sm   hover:bg-red-600  hover:text-white" @click="logout()">Sign out</a>
    </div>
</div>
        </div>
      </div>
