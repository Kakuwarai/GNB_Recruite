        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium  md:ml-2 text-gray-400">Add Posting</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    await globalAPI().get(`Posting/lanJob`)
        .then(async (response) => {
            ...
            if (response.status == 200) {
                ...
                numberValidateForm.value.job = response.data.jobType[0].code

                languageList.value = response.data.language
                numberValidateForm.value.language[0] = response.data.language[0].code
...
async function savebutton() {
   ...
   console.log(numberValidateForm.value.recruiter);
    await globalAPI().post(`Posting/AddPosting?tagUsers=${JSON.stringify(numberValidateForm.value.recruiter)}`,  {
