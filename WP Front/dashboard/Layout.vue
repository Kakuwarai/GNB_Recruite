    ...
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            <a class="flex items-center mb-4 sm:mb-0">
                <img src="../images/groupnb.png" class="h-20 mr-3" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap :text-white">GNB</span>
            </a>
        ...
        <span class="block text-sm text-gray-500 sm:text-center :text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:underline">Group NB</a>. All Rights Reserved.</span>
    </div>
</footer>
